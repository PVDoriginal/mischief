...
--
-- [Previous Chapter: Query Traversals]("Mischief.ECS.Tutorial.Guides.QueryTraversals")
--
-- [Next Chapter: Scheduling and Running Systems]("Mischief.ECS.Tutorial.Guides.Scheduling")
--
-- [Main Page]("Mischief.ECS")
module Mischief.ECS.Tutorial.Guides.ImprovingQueries
  ( -- * Learn You an ECS for Great Mischief! - 2.6. Improving Queries
    -- $intro
